...
import org.neerogi.domain.web.ApplicationConversionServiceFactoryBean;
...
privileged aspect ApplicationConversionServiceFactoryBean_Roo_ConversionService {
    ...
    public Converter<ConditionSubTypes, String> ApplicationConversionServiceFactoryBean.getConditionSubTypesToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<org.neerogi.domain.ConditionSubTypes, java.lang.String>() {
    ...
    public Converter<Integer, ConditionSubTypes> ApplicationConversionServiceFactoryBean.getIdToConditionSubTypesConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.Integer, org.neerogi.domain.ConditionSubTypes>() {
            public org.neerogi.domain.ConditionSubTypes convert(java.lang.Integer id) {
    ...
    public Converter<String, ConditionSubTypes> ApplicationConversionServiceFactoryBean.getStringToConditionSubTypesConverter() {
        return new org.springframework.core.convert.converter.Converter<java.lang.String, org.neerogi.domain.ConditionSubTypes>() {
            public org.neerogi.domain.ConditionSubTypes convert(String id) {
    ...
    public Converter<MedicalCondition, String> ApplicationConversionServiceFactoryBean.getMedicalConditionToStringConverter() {
        return new org.springframework.core.convert.converter.Converter<org.neerogi.domain.MedicalCondition, java.lang.String>() {
            public String convert(MedicalCondition medicalCondition) {
                return new StringBuilder().append(medicalCondition.getConsultationId()).append(' ').append(medicalCondition.getConditionType()).append(' ').append(medicalCondition.getInitialDate()).append(' ').append(medicalCondition.getName()).toString();
            }
        };
    }
