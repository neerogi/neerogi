...
import org.neerogi.domain.web.MedicalConditionController;
...
privileged aspect MedicalConditionController_Roo_Controller {
    ...
    void MedicalConditionController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("medicalCondition_initialdate_date_format", DateTimeFormat.patternForStyle("MM", LocaleContextHolder.getLocale()));
    }
